...
//            Log.d(TAG, "loadPicture: title "+item.getTitle());
//            Log.d(TAG, "loadPicture: cover "+item.getArtworkMrl());
...
//                    BitmapUtil.getPictureFromCache((MediaWrapper) item) :
//                    AudioUtil.getCoverFromMemCache(v.getContext(), (MediaWrapper) item, 64);
//            if (bitmap != null) {
