...
VLC_LDFLAGS="${VLC_LDFLAGS} -L${NDK_TOOLCHAIN_DIR}/${TARGET_TUPLE}/${LIB_DIR} -lc++abi"
...
if [ ${ANDROID_API} = "21" ] ; then
    ...
    VLC_LDFLAGS="${VLC_LDFLAGS} -L${NDK_TOOLCHAIN_DIR}/${TARGET_TUPLE}/${LIB_DIR} -landroid_support"
fi
